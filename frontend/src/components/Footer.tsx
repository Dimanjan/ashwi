    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-8">
            ...
            <div className="flex items-center space-x-4 bg-gray-800 rounded-lg p-4 hover:bg-gray-700 transition-colors">
              ...
              <div className="text-left">
                <h4 className="text-white font-semibold">Sajedar</h4>
                <p className="text-gray-300 text-sm">AI-Powered Business Automation</p>
                <div className="flex items-center space-x-2 mt-1">
                  <CpuChipIcon className="h-4 w-4 text-blue-400" />
                  <span className="text-xs text-gray-400">AI Chatbots & Web Development</span>
                </div>
              </div>
            </div>
          ...
          {/* Sajedar Backlink Section */}
          <div className="mt-6 text-center">
            <p className="text-gray-400 text-sm mb-3">
              Our website and AI chatbot solutions are developed and maintained by
            </p>
            <a 
            ...
            >
              <img 
                ...
                loading="lazy"
              />
              <span>Sajedar - AI Agent Builder Agency</span>
              <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
              </svg>
            </a>
            <p className="text-gray-500 text-xs mt-2">
              Specializing in AI chatbots, Facebook Messenger integration, and custom web development
            </p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Ashwi Furniture. All rights reserved.
            </p>
